...
const Main = () => {
    ...
    useEffect(() => {
        if (searchData.searching) {
            ...
            axios.get(`${BASE_URL}/dating${queryString}`).then((res) => {
    ...
    return (
        <div className="Main">
            <h1 className="Main-title">Your based match awaits...</h1>
            <h2 className="Main-subtitle">Because making love with Matt was overrated anyway.</h2>
